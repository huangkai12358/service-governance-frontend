...
const cards = computed(() => {
  ...
  return [
    { label: 'API 总数', value: stats.api_total, tip: '已纳管 API 资产' },
    { label: 'APP 总数', value: stats.app_total, tip: '已纳管应用' },
    { label: 'API 分组数', value: stats.api_group_total, tip: 'API 分组资源集合' },
    { label: 'APP 分组数', value: stats.app_group_total, tip: 'APP 分组资源集合' },
    { label: '授权关系数', value: stats.auth_relation_total, tip: '单应用授权关系' },
    { label: 'SmartDoc 导入次数', value: stats.smartdoc_import_total, tip: '历史导入次数' },
